...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, MaksCoolMod.MODID);
    ...
    public static final RegistryObject<Block> OWO_ORE = registerBlock("owo_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.DIAMOND_ORE).sound(SoundType.STONE).strength(2f).requiresCorrectToolForDrops(), UniformInt.of(3,7)));
